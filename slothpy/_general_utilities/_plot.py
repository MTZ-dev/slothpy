def _plot_energy_levels(array, cutoff=0, energy_unit='wavenumber', marker_size=500, marker_width=2, marker_color='#000000', decimals=2, frame_width=1, frame_color='#000000', tick_length=6, tick_width=1, tick_direction='out', tick_colour='#000000' ,):
