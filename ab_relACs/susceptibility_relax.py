...
def add_rho0_bundle_comp(rho_vec_init_i_t, M_rho0_trace, A_e, Yb_table, wb, bose, beta_t, w_n, q_0, rho_mat_t, thread_id, t_index, run_rho0):
    raise NotImplementedError
...
def susceptibility_relax_time(
    ...
    build_matrices(hessian, masses_inv_sqrt, dof_array, H_grad, grid, weights,
                    ...
                    modes_high, literally(kind), literally(qtm), literally(run_KR),
                    literally(run_PSI), literally(run_rho0), literally(run_R21))
